    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            */
            ...
            holder.getnumber = (TextView) convertView.findViewById(R.id.id_ItemNum);
        ...
        holder.getnumber.setText("购买数量："+Integer.toString(list.get(position).how_many_in_the_cart()));
